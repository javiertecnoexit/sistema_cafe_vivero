...
- [`docs/mobile.md`](docs/mobile.md) — roles y experiencia móvil de campo (cámara/códigos).
- [`docs/deploy.md`](docs/deploy.md) — plan de despliegue en producción (VPS + EasyPanel).
